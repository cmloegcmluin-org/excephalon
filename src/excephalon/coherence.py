...
GATE_PROMPT = (
    ...
    "Having MENTIONED that an update exists is not having given it: 'I've got an update on X "
    "when you're ready' delivers nothing, and neither does naming X in a list. Only the content "
    "above reaching him counts. If you are weighing it up at all, say SAY.\n\n"
