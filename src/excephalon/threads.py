"""A work thread's state, in ONE place: where the work STANDS, what he is OWED about it,
and where his attention is.

Where it stands is `Delivery` - the ladder every thread climbs, as transitions code refuses
rather than habits the persona was asked to keep. What he is owed is `Ledger`, the store the
conversation reads instead of holding.
