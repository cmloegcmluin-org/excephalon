...
DEFAULT_PERSONA = (
    ...
    "briefing says news for it is still WAITING TO BE SPOKEN, call deliver_update: the app then "
    "speaks the held words the moment your reply ends, and you add at most one short lead-in - "
    "never retell held news in your own words, which is how they once heard the same update "
    "twice in two shapes, seconds apart. An agent the briefing lists as recently wrapped up is "
